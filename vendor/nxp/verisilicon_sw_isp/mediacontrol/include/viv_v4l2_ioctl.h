...
static std::unordered_map<std::string, int> v4l2_cid_map = {
    ...
    { IF_AE_G_STATUS,   ISPCORE_MODULE_AE_STATUS_GET },
    { IF_AE_S_ISO,      ISPCORE_MODULE_AE_SENSITIVITY_SET},
    { IF_AE_G_ISO,      ISPCORE_MODULE_AE_SENSITIVITY_GET},
    ...
    { IF_AF_G_AVI,      ISPCORE_MODULE_AF_AVI_GET },
    ...
    { IF_AWB_G_STATUS,  ISPCORE_MODULE_AWB_STATUS_GET },
    { IF_AWB_G_ILLUMPRO,ISPCORE_MODULE_AWB_ILLUMPRO_GET },
    { IF_AWB_S_MEASWIN, ISPCORE_MODULE_AWB_MEAS_WIN_SET },
    ...
    { IF_CPROC_S_COEFF,     ISPCORE_MODULE_CPROC_COEFF_SET },
    ...
    { IF_EC_G_STATUS,   ISPCORE_MODULE_EC_STATUS_GET },
    ...
    { IF_FILTER_G_TBL,  ISPCORE_MODULE_FILTER_TABLE_GET },
    { IF_FILTER_G_STATUS, ISPCORE_MODULE_FILTER_STATUS_GET },
    ...
    { IF_LSC_G_STATUS,  ISPCORE_MODULE_LSC_STATUS_GET },
    ...
    { IF_WB_S_GAIN,     ISPCORE_MODULE_WB_CFG_SET },
    { IF_WB_S_CCM,      ISPCORE_MODULE_WB_CFG_SET },
    { IF_WB_S_OFFSET,   ISPCORE_MODULE_WB_CFG_SET },
    ...
    { IF_WDR_G_STATUS,  ISPCORE_MODULE_WDR_STATUS_GET },
    { IF_WDR_RESET,     ISPCORE_MODULE_WDR_RESET },
    { IF_WDR_S_TBL,     ISPCORE_MODULE_WDR_TABLE_SET },
    { IF_WDR_G_TBL,     ISPCORE_MODULE_WDR_TABLE_GET },
    ...
    { IF_SENSOR_G_SEC,  ISPCORE_MODULE_SENSOR_SEC_GET },
    { IF_SENSOR_S_SEC,  ISPCORE_MODULE_SENSOR_SEC_SET },
    { IF_SENSOR_S_TESTPAT, ISPCORE_MODULE_SENSOR_TESTPATTERN_SET },
    { IF_SENSOR_INFO,   ISPCORE_MODULE_SENSOR_INFO },

    { IF_DWE_G_PARAMS,  VIV_V4L_DWE_GET_PARAM },
    { IF_DWE_S_PARAMS,  VIV_V4L_DWE_SET_PARAM },
    { IF_DWE_G_HFLIP,   VIV_V4L_DWE_GET_HFLIP },
    { IF_DWE_S_HFLIP,   VIV_V4L_DWE_SET_HFLIP },
    { IF_DWE_G_VFLIP,   VIV_V4L_DWE_GET_VFLIP },
    { IF_DWE_S_VFLIP,   VIV_V4L_DWE_SET_VFLIP },
    { IF_DWE_G_BYPASS,  VIV_V4L_DWE_GET_BYPASS },
    { IF_DWE_S_BYPASS,  VIV_V4L_DWE_SET_BYPASS },
    { IF_DWE_G_MODE,    VIV_V4L_DWE_GET_MODE },
    { IF_DWE_S_MODE,    VIV_V4L_DWE_SET_MODE },
    { IF_DWE_G_MAT,     VIV_V4L_DWE_GET_MATRIX },
    { IF_DWE_S_MAT,     VIV_V4L_DWE_SET_MATRIX },
    { IF_DWE_G_TYPE,    VIV_V4L_DWE_GET_TYPE },
    { IF_DWE_S_TYPE,    VIV_V4L_DWE_SET_TYPE },

    { IF_CAPTURE,       VIV_V4L_MC_CAPTURE },
    { IF_S_FPS,                 ISPCORE_MODULE_SENSOR_FPS_SET },
    { IF_G_FPS,                 ISPCORE_MODULE_SENSOR_FPS_GET },
    { IF_OUT_FMT,               ISPCORE_MODULE_DEVICE_OUTPUT_IMAGE_FORMAT },
    { IF_G_RESOLUTION,          ISPCORE_MODULE_DEVICE_RESOLUTION_GET },
    { IF_SENSOR_LIB_PRELOAD,    ISPCORE_MODULE_SENSOR_PRE_LOAD_LIB },
    { IF_PIPELINE_S_WARM_UP,    ISPCORE_MODULE_PIPELINE_WARM_UP },
    { IF_CALIBRATION_GET,       ISPCORE_MODULE_DEVICE_CALIBRATIONSAVE},
    { IF_CALIBRATION_SET,       ISPCORE_MODULE_DEVICE_CALIBRATIONLOAD},
    { IF_INPUTINFO,             ISPCORE_MODULE_DEVICE_INPUTINFO},
    { IF_INPUTSWITCH,           ISPCORE_MODULE_DEVICE_INPUTSWITCH},
    ...
    { IF_PIPELINE_S_3A_LOCK,    ISPCORE_MODULE_PIPELINE_3A_LOCK_SET},
    { IF_PIPELINE_G_3A_LOCK,    ISPCORE_MODULE_PIPELINE_3A_LOCK_GET},

    { IF_MODULE_DATA_PARSE,  ISPCORE_MODULE_DEVICE_DATA_PARSE },
    { IF_MODULE_DATA_G,      ISPCORE_MODULE_DEVICE_DATA_GET },
