...
Ec &Ec::configGet(Json::Value &, Json::Value &jResponse) {
  TRACE_CMD;
  ...
  jResponse[KEY_TIME] = static_cast<double>(ec.integrationTime);
...
Ec &Ec::configSet(Json::Value &jQuery, Json::Value &jResponse) {
  ...
  ec.integrationTime = jQuery[KEY_TIME].asFloat();
...
Ec &Ec::statusGet(Json::Value &, Json::Value &jResponse) {
  TRACE_CMD;
  ...
  Json::Value &jIntegrationTime = jResponse[KEY_TIME];
