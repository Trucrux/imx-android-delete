...
then
    ...
    then
        ...
        cmake -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DISP_VERSION=ISP8000NANO_V1802 -DPLATFORM=ARM64 -DAPPMODE=V4L2 -DTUNINGEXT=1 \
	...
	-DIMX_G2D=ON -DSDKTARGETSYSROOT=$SDKTARGETSYSROOT -Werror=date-time -Wno-dev ..
        ...
        cmake -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DISP_VERSION=ISP8000NANO_V1802 -DPLATFORM=ARM64 -DAPPMODE=NATIVE -DTUNINGEXT=1 \
	...
	-DQTLESS=1 -DFULL_SRC_COMPILE=1 -DWITH_DWE=1 -DWITH_DRM=1 -DSERVER_LESS=1 -DSUBDEV_V4L2=1 -DENABLE_IRQ=1 \
	-DPARTITION_BUILD=0 -D3A_SRC_BUILD=0 -DIMX_G2D=ON -DTUNINGEXT=1 -DSDKTARGETSYSROOT=$SDKTARGETSYSROOT -Wno-dev ..
    else
        echo "NATIVE mode build ------------------->"
