...
LOCAL_SRC_FILES :=  media_profiles_8q.xml
endif
...
LOCAL_SRC_FILES :=  media_profiles_720p.xml
else ifeq ($(BOARD_SOC_TYPE),IMX8ULP)
LOCAL_SRC_FILES :=  media_profiles_720p.xml
else ifeq ($(BOARD_SOC_TYPE),IMX93)
LOCAL_SRC_FILES :=  media_profiles_720p.xml
else
...
# On 8mp, ov5640 use 30fps
ifeq ($(BOARD_SOC_TYPE),IMX8MP)

include $(CLEAR_VARS)
LOCAL_SRC_FILES :=  media_profiles_8mp-ispsensor-ov5640.xml
LOCAL_MODULE := media_profiles_8mp-ispsensor-ov5640.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_VENDOR_MODULE := true
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_SRC_FILES :=  media_profiles_8mp-ov5640.xml
LOCAL_MODULE := media_profiles_8mp-ov5640.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_VENDOR_MODULE := true
include $(BUILD_PREBUILT)
