...
/*!
 * brief Blocks to check if able to send a message.
 *
 * This function waits until the TX register is empty.
 *
 * param base MU peripheral base address.
 * param regIndex  TX register index.
 */
static inline void MU_WaitTxReady(MU_Type *base, uint32_t regIndex)
{
    assert(regIndex < MU_TR_COUNT);
