...
const ccm_analog_frac_pll_config_t g_audioPll1SConfig = {
    .refSel  = kANALOG_PllRefOsc24M, /*!< PLL reference OSC24M */
    .mainDiv = 200U,
    .dsm     = 0U,
    .preDiv  = 3U,
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Only enable audio PLLx when required */
...
#else
    CLOCK_SetRootDivider(kCLOCK_RootAudioAhb, 1U, 1U);                    /* Set root clock freq to 24 MHZ*/
    CLOCK_SetRootMux(kCLOCK_RootAudioAhb, kCLOCK_AudioAhbRootmuxOsc24M);  /* it maybe changed by Linux side */
    mmio_write_32(0x30388300, 0x10000000); /* Audio AXI to 24M */         /* it maybe chanaged by Linux side */
#endif
